...
const StatRoleSchema = new mongoose.Schema(
  {
    ...
    statKey: {
      type: String,
      required: true,
      enum: ["goals", "assists", "shots", "hits", "pim", "plusMinus", "saves", "goalsAgainst", "faceoff_tracker", "hit_penalty_tracker", "shots_goals_tracker", "time_of_possession", "pass_tracker"],
    },
  },
  { timestamps: true }
);
